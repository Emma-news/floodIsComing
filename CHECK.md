...
1. Please register with username (i.e.: Emma_news) at https://www.geonames.org/login  
2. Assign the choosen username as new organization secret at https://github.com/organizations/Emma-news/settings/secrets/actions/new  
   * Name:  **GEONAMES_KEY**   
...
3. Assign the API key as new organization secret at https://github.com/organizations/Emma-news/settings/secrets/actions/new  
   * Name:  **RAPIDAPI_KEY**   
   * Value: **Your key here**   
